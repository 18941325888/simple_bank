...
migrateup:
	migrate -path db/migrations -database "postgresql://root:3129ci32r8udspq-9128jed@simple-bank.c1ugnplnbdwv.ap-east-1.rds.amazonaws.com:5432/simple_bank" -verbose up
migrateup1:
